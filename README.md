...
For the remote repository, make a github repository named HW2, then do;

```bash
git remote add origin git@github.com:shalinikc/HW2.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── HW2	<- Your notebooks and scripts will live in the main project folder
